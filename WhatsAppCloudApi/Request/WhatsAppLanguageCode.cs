...
public static class WhatsAppLanguageCode
{
    public const string Afrikaans = "af";

    public const string Albanian = "sb";
    ...
    public const string Chinese_CHN = "zh_CN";

    public const string Chinese_HKG = "Zh_HK";

    public const string Chinese_TAI = "zh_TW";
    ...
    public const string English_UK = "en_GB";
    ...
    public const string Kinyarwanda = "rw_RW";

    public const string Korean = "ko";

    public const string Kyrgyz_Kyrgyzstan = "ky_KG";
    ...
    public const string Portuguese_BR = "pt_BR";

    public const string Portuguese_POR = "pt_PT";
    ...
    public const string Spanish_ARG = "es_AR";

    public const string Spanish_SPA = "es_ES";

    public const string Spanish_MEX = "es_MX";
